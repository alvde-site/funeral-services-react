  ...
  return (<section className="services">
    ...
    <ul className="services__catalog">
      <li className="services__card">
        ...
        <p className="services__desc">Вертикальные памятники - классический вариант могильных надгробий</p>
        <p className="services__price-text">от <span className="service__price">300 BYN</span></p>
        <button className="services__feedback" onClick={handleOpenFeedback}>Заказать</button>
      </li>
      <li className="services__card">
        ...
        <p className="services__desc">Чаще всего устанавливается для двух, трех и более надгробий</p>
        <p className="services__price-text">от <span className="service__price">300 BYN</span></p>
        <button className="services__feedback" onClick={handleOpenFeedback}>Заказать</button>
      </li>
      <li className="services__card">
        ...
        <p className="services__desc">Используются разные виды крестов, которые имеют разный смысл</p>
        <p className="services__price-text">от <span className="service__price">300 BYN</span></p>
        <button className="services__feedback" onClick={handleOpenFeedback}>Заказать</button>
      </li>
      <li className="services__card">
        ...
        <p className="services__desc">Двойной памятник на могилу - для парных  и семейных захоронений</p>
        <p className="services__price-text">от <span className="service__price">300 BYN</span></p>
        <button className="services__feedback" onClick={handleOpenFeedback}>Заказать</button>
      </li>
      <li className="services__card">
        ...
        <p className="services__desc">Изготавливаются из 2-х или более видов камня</p>
        <p className="services__price-text">от <span className="service__price">300 BYN</span></p>
        <button className="services__feedback" onClick={handleOpenFeedback}>Заказать</button>
      </li>
      <li className="services__card">
